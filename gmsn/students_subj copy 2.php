                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center" contenteditable="true" data-field="grade" data-id="<?php echo $row['enrollID']; ?>">
                                                            <?php echo ($row['grade'] != 0) ? $row['grade'] : ''; ?>
                                                        </td>
                                                        <td class="text-center" contenteditable="true" data-field="grade2" data-id="<?php echo $row['enrollID']; ?>">
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.save-btn', function() {
            ...
            var newGradeFirst = $(this).closest('tr').find('td[data-field="grade"]').text();
            var newGradeSecond = $(this).closest('tr').find('td[data-field="grade2"]').text();



            if (newGradeFirst < 0 || newGradeFirst > 100 || isNaN(newGradeFirst)) {
                Swal.fire({
                    icon: 'error',
                    title: 'Invalid Grade',
                    text: 'Please enter a valid grade between 60.00 and 100.00.',
                }).then(() => {
                    location.reload();
                });
                return;
            }
            if (newGradeSecond < 0 || newGradeSecond > 100 || isNaN(newGradeSecond)) {
                Swal.fire({
                    icon: 'error',
                    title: 'Invalid Grade',
                    text: 'Please enter a valid grade between 60.00 and 100.00.',
            ...
            $.ajax({
                ...
                error: function() {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Error saving first quarter grade.',
                    });
                }
            });
            ...
            $.ajax({
                ...
                error: function() {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Error saving second quarter grade.',
                    });
                }
            });
        });
