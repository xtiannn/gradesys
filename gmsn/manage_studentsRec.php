...
<main id="main" class="main mt-0">
            ...
            <div class="custom-container">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="studTable" class="table table-striped table-bordered datatable" style="font-size: 14px;">
                                <thead>
                                    <?php 
                                        ...
                                        AND lrn IS NOT NULL
                                        ORDER BY gender DESC, lname ASC, fname ASC, mname ASC";
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="" role="group" aria-label="Student Actions">
                                                    ...
                                                    <button class="btn btn-info btn-sm view-btn" data-bs-toggle="modal" data-bs-target="#viewStudentInfo" data-student-id="<?php echo $student['studID']; ?>">
                                                    <i class="bi bi-eye"></i>
                                                    </button>
                                                    <?php require_once "modals/studentInfo.php"?>
  ...
  <script>
    ...
    text: 'You are about to remove student: ' + studentName,
    icon: 'warning',
