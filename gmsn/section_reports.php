...
<body>
  ...
  <?php 
    ...
    $query = 
    "SELECT ss.*, s.lrn, CONCAT(s.lname, ', ', s.fname, ' ',s.mname) AS studname, s.photo
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="d-flex flex-column">
                                    <h6 class="custom-card-title"><i class="bi bi-star me-2"></i>Section Reports</h6>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-success btn-sm" type="button" href="students_subjRecord.php?studID=<?php echo $row['studID']; ?>">
                                                Grades <i class="bi bi-star ms-1"></i> 
                                                </a>
