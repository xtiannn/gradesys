                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <fieldset class="border p-4 rounded mb-4" id="studentField">
                            ...
                            <!-- Name Inputs -->
                            <div class="row">
                                <label for="studentFull" class="form-label fw-bold">Full Name: <span class="required-asterisk">*</span></label>
                            </div>
                            <div class="row mb-4">
                                <div class="col-md-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <label for="contactnum" class="form-label fw-bold">Contact Number: <span class="required-asterisk">*</span></label>
                            ...
                            <div class="row mb-4">
                                ...
                                <input type="checkbox" name="keepAddressCB" id="keepAddressCB" style="display: block;" checked>
                            ...
                            <div class="row mb-4">
                                ...
                                <!-- Language Input -->
                                <div class="col-md-4">
                                    <label for="language" class="form-label fw-bold">Language/s Spoken:</label>
                        ...
                        <fieldset class="border p-4 rounded mb-4" id="fatherField">
                            ...
                            <div class="fatherInfo" id="fatherInfo">
                                <!-- Father Inputs -->
                                <div class="row">
                                    <label for="fatherFull" class="form-label fw-bold">Full Name: <span class="required-asterisk">*</span></label>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="fatherlname" name="txtFatherlname" placeholder="Last Name" value="<?php echo $student['flname']?>" required>
                                        <div class="invalid-feedback">
                                            Please enter the father's Last Name.
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="fatherfname" name="txtFatherfname" placeholder="First Name" value="<?php echo $student['ffname']?>" required>
                                        <div class="invalid-feedback">
                                            Please enter the father's First Name.
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="fathermname" name="txtFathermname" placeholder="Middle Name" value="<?php echo $student['fmname']?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                    <label for="fatherage" class="form-label fw-bold">Age: <span class="required-asterisk">*</span></label>
                                        <input type="number" name="txtFatherAge" id="fatherage" class="form-control" placeholder="Father's Age" value="<?php echo $student['fage'] ?? ''?>" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <option disabled value="" <?php echo empty($selectedFeduc) ? 'selected' : ''?>>Select One</option>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="fatheroffice" name="txtFatherOffice" placeholder="" value="<?php echo $student['foffice']?>">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <!-- Fetched Address for father -->
                                <div class="row mb-4">
                                    <!-- Parent Label for Address of student -->
                                    <input type="checkbox" name="keepFatherAddressCB" id="keepFatherAddressCB" style="display: block;" checked>
                                    <div class="col-12 d-flex align-items-center justify-content-between">
                        ...
                        <fieldset class="border p-4 rounded mb-4" id="motherField">
                            ...
                            <div class="motherInfo" id="motherInfo">
                                <!-- Father Inputs -->
                                <div class="row">
                                    <label for="motherFull" class="form-label fw-bold">Full Name: <span class="required-asterisk">*</span></label>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="motherlname" name="txtMotherlname" placeholder="Last Name" value="<?php echo $student['mlname']?>" required>
                                        <div class="invalid-feedback">
                                            Please enter the mother's Last Name.
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="motherfname" name="txtMotherfname" placeholder="First Name" value="<?php echo $student['mfname']?>" required>
                                        <div class="invalid-feedback">
                                            Please enter the mother's First Name.
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="mothermname" name="txtMothermname" placeholder="Middle Name" value="<?php echo $student['mmname']?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                    <label for="motherage" class="form-label fw-bold">Age: <span class="required-asterisk">*</span></label>
                                        <input type="number" name="txtMotherAge" id="motherage" class="form-control" placeholder="Mother's Age" value="<?php echo $student['mage'] ?? ''?>" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="motheroffice" name="txtMotherOffice" placeholder="" value="<?php echo $student['moffice']?>">
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row mb-4">
                                    <!-- Parent Label for Address of student -->
                                    <input type="checkbox" name="keepMotherAddressCB" id="keepMotherAddressCB" style="display: block;" checked>
                                    <div class="col-12 d-flex align-items-center justify-content-between">
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                function updateGuardianOptions() {
                                    ...
                                    selGuardian.innerHTML = '<option value="" selected disabled>Select Relationship</option>';
                                    ...
                                    // Add the "Others" option as the last option
                        ...
                        <fieldset class="border p-4 rounded mb-4" id="gdField">
                            ...
                            <div class="row mb-4">
                                ...
                                <label for="selGuardian" class="form-label fw-bold">Select Guardian: <span class="required-asterisk">*</span></label>
                                    <?php $selectedGuardian = $student['relationship'] ?? ''?>
                            ...
                            <!-- Guardian Inputs -->
                            <div class="row">
                                    <label for="gdFull" class="form-label fw-bold">Full Name: <span class="required-asterisk">*</span></label>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="gdlname" name="txtGdlname" placeholder="Last Name"  >
                                        <div class="invalid-feedback">
                                            Please enter the guardian's Last Name.
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="gdfname" name="txtGdfname" placeholder="First Name"  >
                                        <div class="invalid-feedback">
                                            Please enter the guardian's First Name.
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="gdmname" name="txtGdmname" placeholder="Middle Name" >
                                    </div>
                                </div>
                                <!-- Checkbox for same address -->
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <label for="gdHouseNumber" class="form-label fw-bold">Complete Address: <span class="required-asterisk">*</span></label>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="sameAddressCheckboxG" name="sameAddressCheckboxG">
                                            <label class="form-check-label" for="sameAddressCheckboxG">
                                ...
                                <!-- Guardian address -->
                                <div class="gdAdress" id="gdAdress">
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control" id="gdHouseNumber" name="txtGdHouseNumber" placeholder="House No." >
                                            <div class="invalid-feedback">
                                                Please enter the house number.
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control" id="gdStreetName" name="txtGdStreetName" placeholder="Street Name" >
                                            <div class="invalid-feedback">
                                                Please enter the street name.
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3">
                                            <input type="text" class="form-control" id="gdSubdivision" name="txtGdSubdivision" placeholder="Subdivision/Village" >
                                            <div class="invalid-feedback">
                                                Please enter the subdivision.
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        <select class="form-select form-control selectpicker" id="gdRegion" data-live-search="true" name="txtGdRegion" >
                                            <option value="" selected disabled>Select Region</option>
                                            <?php
                                            try {
                                                $query = "SELECT regCode, regDesc FROM refregion";
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3">
                                        <select class="form-select form-control selectpicker" id="gdProvince" data-live-search="true" >
                                            <option value="" selected disabled>Select Province</option>
                                        </select>
                                        <input type="hidden" id="selectedProvinceDescG" name="txtGdProvince">
                                            <div class="invalid-feedback">
                                                Please select a province.
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        <select class="form-select form-control selectpicker" id="gdCity" data-live-search="true" >
                                            <option value="" selected disabled>Select City/Municipality</option>
                                        </select>
                                        <input type="hidden" id="selectedCityDescG" name="txtGdCity">
                                            <div class="invalid-feedback">
                                                Please select city or municipality.
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3">
                                            <select class="form-select form-control selectpicker" id="gdBarangay" data-live-search="true" >
                                                <option value="" selected disabled>Select Barangay</option>
                                            </select>
                                            <input type="hidden" id="selectedBarangayDescG" name="txtGdBarangay">
                                            <div class="invalid-feedback">
                                                Please select barangay.
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <input type="number" class="form-control" id="gdPostalCode" name="txtGdPostalCode" placeholder="Postal Code" >
                                            <div class="invalid-feedback">
                                                Please enter the Postal code.
                                            </div>
                                        </div>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            // Toggle relationship input visibility
                            const selGuardian = document.getElementById('selGuardian');
                            const guardianFields = document.getElementById('gdInfo');
                            
                            function setupOtherGuardian() {
                            ...
                            // Check on change
                            selGuardian.addEventListener('change', setupOtherGuardian);

                            // Handle address checkbox
                            const sameAddressCheckbox = document.getElementById('sameAddressCheckboxG');
                            const guardianAddressFields = document.getElementById('gdAdress');
                            
                            function toggleAddressFields() {
                                if (sameAddressCheckbox.checked) {
                                    guardianAddressFields.style.display = 'none';
                                } else {
                                    guardianAddressFields.style.display = 'block';
                                }
                            }
                            ...
                            // Check on change
                            sameAddressCheckbox.addEventListener('change', toggleAddressFields);
