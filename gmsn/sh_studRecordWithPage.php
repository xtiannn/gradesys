...
<script>
    ...
    function validateFieldset(fieldset) {
        ...
        requiredFields.forEach(field => {
            ...
            if (field.tagName === 'SELECT') {
                // Handle selectpicker separately
    ...
    // Remove validation feedback on input change for text fields
    const requiredFields = document.querySelectorAll('[required]');
    requiredFields.forEach(field => {
        if (field.tagName === 'SELECT') {
            // Listen for change event for selectpicker elements
            ...
            // Listen for input event for text fields
