                            ...
                            <fieldset class="border p-4 rounded mb-4" id="studentField">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="studentmname" name="txtStudentmname" placeholder="(if any)">
                                    </div>
                                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        motherCheckbox.addEventListener('change', function() {
            ...
            updateGdInfoVisibility(); // Update gdInfo visibility after toggling motherInfo
                            ...
                            <div class="col-12">
                                <div class="text-end">
                                    <a href="manage_studentsRec.php" type="button" class="btn btn-secondary m-1">
                                        <i class="bi bi-arrow-left"></i> Back
                                    </a>
                                    <button type="reset" class="btn btn-warning m-1">
                                        <i class="bi bi-arrow-counterclockwise"></i></i> Reset
                                    </button>
                                    <button type="submit" class="btn btn-primary m-1" name="saveStudentBtn">
