                    ...
                    <fieldset class="border p-4 rounded mb-4">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="gradelvlcode" name="txtGradelvlCode" placeholder="Code" Required>
                            </div>
                        </div>
                        </div>
                        <div class="row mb-3">
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="gradelvlname" name="txtGradelvlName" placeholder="Grade Level" Required>
                            </div>
                        </div>
                        </div>
                    </fieldset>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="save_gradelvl.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    <fieldset class="border p-4 rounded mb-4">
                        <legend class="mb-4">Create Grade Level</legend>
                        <input type="hidden" name="gradelvlID" id="gradelvlIDup">
                        <div class="row mb-3">
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="updatecode" name="txtGradelvlCode" placeholder="Code" Required>
                            </div>
                        </div>
                        </div>
                        <div class="row mb-3">
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="updatename" name="txtGradelvlName" placeholder="Grade Level" Required>
                            </div>
                        </div>
                        </div>
...
<script>
$(document).on('click', '.updateGradelvl-btn', function() {
...
<script>
    function handleDeleteButtonClick(gradelvlId, gradelvlName) {
        Swal.fire({
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.delete-btn').forEach(function(btn) {
            btn.addEventListener('click', function(event) {
                ...
                handleDeleteButtonClick(gradelvlId, gradelvlName);
            });
        });
    });
</script>
