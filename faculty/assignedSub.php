 ...
 IF (!isset($_SESSION['userID'])) {
  ...
  try {
      ...
      $_SESSION['facultyID'] = $facultyID;
          ...
          LEFT JOIN semester sm ON fa.semID = sm.semID
          LEFT JOIN sections sc ON fa.secID = sc.secID
          LEFT JOIN grade_level g ON fa.gradelvlID = g.gradelvlID
          WHERE fa.facultyID = :facultyID AND sc.isActive=1 AND fa.ayName = :ayName AND (fa.semID = :semID OR fa.semID IS NULL)
          ORDER BY s.subjectname ASC, g.gradelvlcode DESC";
          ...
          <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex flex-column">
                    ...
                    <i class="bi bi-list me-2"></i> Assigned Subjects
                    </h6>
                </div>
                <a class="btn btn-sm btn-secondary" href="inactiveSubject.php">
                  ...
                  foreach ($subjects as $subject): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a style="width: 40px; height: auto" href="students.php?subjectID=<?php echo $subject['subjectID']?>&facultyID=<?php echo $facultyID?>&faID=<?php echo $subject['facultyAssignID']?>&secID=<?php echo $subject['secID']?>&semID=<?php echo ($subject['semID'] != NULL) ? $subject['semID'] : NULL?>&deptID=<?php echo $subject['deptID']?>&programID=<?php echo $subject['programID']?>" 
                          type="button" 
