                    ...
                    <fieldset class="border p-4 rounded mb-4">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 mb-3">
                                <label for="facultynumber" class="form-label fw-bold">Faculty ID:</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="bi bi-person-badge"></i></span>
                                    </div>
                                    <input type="text" class="form-control" id="facultynumber" name="txtFacultyNumber" placeholder="Faculty ID" required>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-12 mb-3">
                                <label for="facultylname" class="form-label fw-bold">Full Name:</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="bi bi-person"></i></span>
                                    </div>
                                    <input type="text" class="form-control" id="facultylname" name="txtFacultylname" placeholder="Last Name" required>
                                    <input type="text" class="form-control" id="facultyfname" name="txtFacultyfname" placeholder="First Name" required>
                                    <input type="text" class="form-control" id="facultymname" name="txtFacultymname" placeholder="Middle Name" required>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <label for="gender" class="form-label fw-bold">Gender:</label>
                                ...
                                <select class="form-select form-control selectpicker" id="gender" name="txtFacultyGender" required>
                            ...
                            <label for="contactnum" class="form-label fw-bold">Contact No.:</label>
                                ...
                                <input type="number" class="form-control" name="txtFacultyContactNum" id="contactnum" placeholder="Contact Number" required>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" id="confirmPassword" name="txtConfirmPassword" placeholder="Confirm Password" required>
                    ...
                    if (xhr.status === 200) {
                        ...
                        if (response.status === 'success') {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
                                text: 'Failed to delete the ' + response.message
                            });
                        }
                    } else {
